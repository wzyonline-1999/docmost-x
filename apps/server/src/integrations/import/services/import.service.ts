...
export class ImportService {
  ...
  async processDocx(
    ...
    this.logger.error('DOCX import is not available in the community build');
    throw new BadRequestException('DOCX import is not available in this build.');
  }
  ...
  async processPdf(
    ...
    this.logger.error('PDF import is not available in the community build');
    throw new BadRequestException('PDF import is not available in this build.');
  }
