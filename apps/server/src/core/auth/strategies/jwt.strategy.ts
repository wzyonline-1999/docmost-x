...
export class JwtStrategy extends PassportStrategy(Strategy, 'jwt') {
  ...
  private async validateApiKey(req: any, payload: JwtApiKeyPayload) {
    this.logger.debug('API key authentication is not available in the community build');
    throw new UnauthorizedException('API key authentication is not available in this build');
  }
}
